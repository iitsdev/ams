...
// filepath: c:\Users\daveg\Desktop\Projects\ams\resources\js\pages\settings\brands\Create.vue
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create', href: route('brands.create') }
]
        ...
        <form @submit.prevent="submit" class="mt-6 px-4 max-w-2xl mx-auto">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Add a new brand to your asset management system.
                    </CardDescription>
                </CardHeader>
                <CardContent class="space-y-4">
                    <div class="grid gap-3">
                        <Label for="name">Brand Name <span class="text-red-500">*</span></Label>
                        <Input id="name" v-model="form.name" type="text" placeholder="e.g., Apple, Dell, HP" required />
